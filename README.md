...
- **Version 7:** Master key recoding logic for login password updates
...
- **Key Recoding:** Automatic re-encryption of the persistent master key whenever the user changes their login password.
